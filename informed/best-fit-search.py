...
pygame.display.set_caption("Best-Fit Search Path Finding Algorithm")
...
def display_time_in_caption(duration):
    pygame.display.set_caption(f"Best Fit Search Path Finding Algorithm - Time: {duration:.4f} seconds")
